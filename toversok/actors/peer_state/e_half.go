...
func (e *EstHalf) OnDirect(ap netip.AddrPort, clear *msg.ClearMessage) PeerState {
...
func (e *EstHalf) OnRelay(relay int64, peer key.NodePublic, clear *msg.ClearMessage) PeerState {
